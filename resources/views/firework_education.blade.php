    ...
    <div class="accordion" id="accordionPanelsStayOpenExample">
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
            <div class="accordion-body fs-4">
              ...
              <img class="img-fluid" src="https://d34dnz415a0ab2.cloudfront.net/lighting-rocket.jpg" alt="How to light a Rocket">
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
            <div class="accordion-body fs-4">
              ...
              <img class="img-fluid" src="https://d34dnz415a0ab2.cloudfront.net/ignite-cake-fuse.jpg" alt="How to light a Rocket">
              <ul class="list-group list-group-flush">
        ...
        <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingFour">
              ...
              <img class="img-fluid" src="https://d34dnz415a0ab2.cloudfront.net/fountain-fuse-nozzle.png" alt="How to light a fountain firework">
              <ul class="list-group list-group-flush">
                <li class="list-group-item">
                  {{-- TODO --}}
                </li>
        ...
        <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseFive" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingFive">
              ...
              <img class="img-fluid" src="https://d34dnz415a0ab2.cloudfront.net/lighting-sparklers.jpg" alt="How to light a Sparkler">
              <ul class="list-group list-group-flush">
                <li class="list-group-item">
                  {{-- TODO --}}
                </li>
          ...
          <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseSix" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingSix">
              ...
              <div class="row">
                <div class="col-md-6">
                  <img class="img-fluid" src="https://d34dnz415a0ab2.cloudfront.net/ignite-candle.jpg" alt="How to light a Roman Candle">
                </div>
                <div class="col-md-6">
                  <img class="img-fluid" src="https://d34dnz415a0ab2.cloudfront.net/lighting-up-roman-candles.jpg" alt="How to handle a lit Roman Candle">
                </div>
              </div>
