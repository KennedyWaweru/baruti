...
<div class="row bg-info">
    ...
    <div class="container my-2">
        <div class="row bg-light">
            <h2 class="fs-2">1. Whose privacy policy is this?</h2>
            <p class="fs-4">
            ...
            <h2 class="fs-2">2. Information We Collect</h2>
            <p class="fs-4">
            ...
            <h2 class="fs-2">3. How We Use Information</h2>
            <p class="fs-4">
            ...
            <h2 class="fs-2">4. Information We Share</h2>
            <p class="fs-4">We do not intend to share your data with any third party.</p>
